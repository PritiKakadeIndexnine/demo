...
TC- Verify The UI Of Welcome Screen
    &{login_data}   Fetch Data By Id    ${new_user_td}   7
    screenshot.set screenshot directory    ${screenshot_actual_dir}
    Set Library Search Order    AppiumLibrary    SeleniumLibrary
    Verify Login Screen
    ...
    AppiumLibrary.capture page screenshot    welcome_screen.png
    ${image_path}=    Set Variable    ${screenshot_actual_dir}/welcome_screen.png
    Compare Images  Reports/Screenshots/reference_screenshots/welcome_screen_image.png    ${image_path}   resize_candidate=True
...
Compare Text Content from Image
    ...
    ${text}     Get Text From Document    ${image_path}    300
    Log    ${text}
    List Should Contain Value   ${text}    OTP
#    List Should Contain Value   ${text}    KNIGHT CLUB
