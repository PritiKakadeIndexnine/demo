...
Test Template   Verify if the user selectes multiple membership for new user

*** Variables ***
${testdata_filepath}    ${CURDIR}${/}..${/}..${/}TestData${/}NewUserMultiple_membership_testdata.xlsx

*** Test Cases ***
Verify if the user selectes multiple membership for new user      ${id}

*** Keywords ***
Verify if the user selectes multiple membership for new user
    [Arguments]    ${id}
