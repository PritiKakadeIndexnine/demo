...
Library   DataDriver        ../../TestData/Single_purchasemembership_data.xlsx
...
Test Template   Verify if the user selectes single membership for new user

*** Variables ***
${testdata_filepath}    ${CURDIR}${/}..${/}..${/}TestData${/}Single_purchasemembership_data.xlsx


*** Test Cases ***
Verify if the user selectes single membership for new user   ${id}

*** Keywords ***
Verify if the user selectes single membership for new user
    [Arguments]    ${id}
